...
import { Agrupacion, GrupoCompra, PrescipcionCompra, Item } from './class/prescripcion-compra.class';
...
export class ClassesCourseComponent extends Parent implements OnInit {
  ...
  instanceJson(): void {
    ...
    this.prescripcion.forEach( (pres, index ) => {
       this.instancePrescipcionCompra = Object.assign(new PrescipcionCompra, pres );
